...
<main id="apropos">
    ...
    <?php
    echo do_shortcode('[banniere-titre titre="À propos de BricoTips" src="http://localhost/bricotips/wp-content/uploads/2025/01/Design-sans-titre-2025-01-20T110635.334.png"]');
    ?>
